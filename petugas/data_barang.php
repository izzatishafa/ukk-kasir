...
<div class="card mt-2">
   <div class="card-body">
      <form action="" method="get">
		...
		<a href="laporan_produk.php" class="btn btn-info btn-sm">Laporan Produk</a>
   ...
   <div class="card-body">
      ...
      <table class="table">
         ...
         <tbody>
            ...
            if (isset($_GET['cari'])) {
               $cari = $_GET['cari'];
               $where = "WHERE NamaProduk LIKE '%$cari%'";
            }

            $no = 1;
            $data = mysqli_query($koneksi, "SELECT * FROM produk $where");
        ...
        if (mysqli_num_rows($data) == 0) {
			...
			echo'<a href="data_barang.php" class="btn btn-info btn-sm">Kembali</a>';
        } else {
