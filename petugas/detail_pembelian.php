		...
		while($d = mysqli_fetch_array($data)){
			...
			<?php if ($d['PelangganID'] == $PelangganID) { ?>
				...
				<form method="post" action="tambah_detail_penjualan.php">
					...
					<?php
				// Tentukan URL halaman yang ingin dituju
				$halaman_tujuan = 'pembelian.php';
				?>

				<!-- Tambahkan tombol dengan tautan ke halaman_tujuan.php -->
				<a href="<?php echo $halaman_tujuan; ?>">
				<button type="button" class="btn btn-primary btn-sm mt-2">Kembali</button>
				</a>
				</form>
				<table class="table">
					<thead>
