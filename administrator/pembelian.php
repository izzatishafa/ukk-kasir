...
<div class="card mt-2">
    <div class="card-body">
        <form action="" method="get">
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Cari pelanggan" name="cari">
    ...
    <div class="card-body">
	   ...
	   <?php
        ...
        // Mencari data jika parameter 'cari' terdefinisi
        $condition = isset($_GET['cari']) ? "WHERE NamaPelanggan LIKE '%" . $_GET['cari'] . "%'" : "";
        $no = 1;
        $data = mysqli_query($koneksi, "SELECT * FROM pelanggan INNER JOIN penjualan ON pelanggan.PelangganID=penjualan.PelangganID " . $condition);
// Menampilkan pemberitahuan jika data tidak ditemukan
        ...
        ?>
            <tr>
                ...
                <td>
					...
					<a class="btn btn-info btn-sm" href="laporan_pembelian.php?PelangganID=<?php echo $d['PelangganID']; ?>">Cetak</a>
                </td>
            </tr>
        <!-- Modal Edit Data-->
