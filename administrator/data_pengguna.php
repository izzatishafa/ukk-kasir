    ...
    <div class="card-body">
        <form action="" method="get">
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Cari petugas" name="cari">
		...
		<a href="laporan_pengguna.php" class="btn btn-info btn-sm">Laporan Pengguna</a>
    </div>
    <div class="card-body">
        <?php
        include '../koneksi.php';
        ...
        $condition = isset($_GET['cari']) ? "WHERE nama_petugas LIKE '%" . $_GET['cari'] . "%'" : "";
        $no = 1;
        $data = mysqli_query($koneksi, "SELECT * FROM petugas " . $condition);		
